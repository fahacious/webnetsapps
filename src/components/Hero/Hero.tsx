        ...
        <div className="mycontainer">
            <div className='px-4 flex-col gap-14 lg:gap-0 lg:flex-row flex items-center justify-center'>
                <div className='lg:flex-1 flex flex-col gap-5 items-center lg:items-start'>
                    ...
                    <p className='text-customGray-main text-center lg:text-left lg:text-[1.3rem]'>Blocks-DApps Mainnet focuses on addressing common issues faced by Web3 applications, such as scalability, interoperability, and user adoption.</p>
                    <a href="/solutions">
